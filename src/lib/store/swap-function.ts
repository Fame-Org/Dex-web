...
export const swapAsset = (from: any, to: any, amount: any, exchange: any, addresses: { from: any }) => {
...
export const funcSwapAsset = async (from: any, to: any, amount: any, exchange: any, addresses: { from: any }) => {
